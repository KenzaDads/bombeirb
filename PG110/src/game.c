...
void game_banner_display(struct game* game) {
	assert(game);
	/*Ici se trouve le code pour le panneau d'informations, où l'on a ajouté le nombre de clés et le numéro de la map*/
	...
	while (SDL_PollEvent(&event)) {
		...
		case SDL_KEYDOWN:
			...
			case SDLK_LEFT:
				...
				player_move(player, map);
				break;
			/*Ici se trouve le code pour le depot de bombe après avoir appuyé sur la touche ESPACE*/
			case SDLK_SPACE:
